...
def draw_centers_with_text(input_img,mask,centers,text_contents,font_size_list,choice_list,stroke):
    ...
    for chosen in choice_list:
        ...
        font = ImageFont.truetype("Arial.ttf", font_size_list[the_index]) 
        text = text_contents
